  ...
  return (
    <>
      ...
      {activePanel && (
        ...
        >
          <div
            className="w-full max-w-2xl bg-white dark:bg-[#1C1C1E] rounded-t-3xl shadow-2xl border border-gray-200 dark:border-gray-800 animate-slide-up"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Card Header */}
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-800">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#4C7F6E] to-[#3D6658] flex items-center justify-center text-white">
              ...
              <button
                onClick={() => setActivePanel(null)}
                className="p-2 rounded-xl text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#2C2C2E] transition-all"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="p-6">
              <div className="flex flex-col items-center justify-center py-12">
                <div className="w-24 h-24 bg-gradient-to-br from-[#4C7F6E]/20 to-[#4C7F6E]/10 rounded-3xl flex items-center justify-center mb-6">
                  <svg className="w-12 h-12 text-[#4C7F6E]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
